...
const SYSTEM_PROMPT = [
  ...
  "title: craft a natural, descriptive title for what the meeting is ABOUT — lead with the activity or topic from the note, and weave in the booker's first name naturally. Short (max ~6 words), warm and professional, in the requested language (de/en); no emojis, no surrounding quotes. Do NOT just glue a generic opener onto the raw note. Examples — note \"Wir wollen Rad fahren am Krupunder See\": \"Radtour am Krupunder See mit Horst\" (de) / \"Cycling Trip with Horst at Krupunder See\" (en); note \"Stall ausmisten\", booker \"Huhn\": \"Ausmisten mit Huhn\" (de). Avoid flat concatenations like \"Termin Huhn Stall ausmisten\".",
